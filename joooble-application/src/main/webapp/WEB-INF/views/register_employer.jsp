...
<html>
	...
	<body>
		<p>
		<form:form modelAttribute="employerRegisterForm" action="registrationEmployer" enctype="multipart/form-data" method="POST">
			...
			<label>Company Name: <input type="text" name="companyName" class="form-control"/> </label><br>
			<label>Company Location: <input type="text" name="companyAddress" class="form-control"/> </label><br>
